...
def bifurcation_worker(a):
	"""worker function for calculating the tragectories of the henon map"""
	vx, vy, vz, vt = rk4(Dx, Dy, Dz, a)
	return vx[-20:]

def bifurcation_pool(a0, a1, a_n):
	with mp.Pool(processes=mp.cpu_count()-1) as pool:
		T = pool.map(bifurcation_worker, np.arange(a0, a1, a_n))
...
def main():
	x0, y0, z0, b, c, t0, Tt, n = return_values()
	a = 0.5
	a0, a1, a_n = 0.2, 0.55, 0.0001 # a_n - Bifurcation step size
